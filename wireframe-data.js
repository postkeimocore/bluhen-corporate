      ...
      sections:[
        {
          ...
          body:'統合報告書やIR資料の英訳にとどまらず、Corporate Narrative、経営者メッセージ、英文コンテンツ、IRサイト、継続的な情報発信まで支援する。',
          visual:'NARRATIVE → EDITORIAL → EXECUTIVE → DIGITAL IR',
          ctas:['英文IRについて相談する','支援内容を見る'],
      ...
      sections:[
        {
          ...
          visual:'VALUE → BRAND → EXPERIENCE → GO-TO-MARKET',
          ctas:['海外展開について相談する','支援領域を見る'],
        ...
        {
          type:'process', eyebrow:'PROCESS', title:'価値を、世界で選ばれる形へ。',
          steps:[
            ['01','Strategy','市場・競合・顧客を理解し、海外展開戦略とポジショニングを設計'],
            ['02','Brand','価値を言葉・ビジュアル・ストーリーへ整理し、現地の文脈へ再設計'],
            ['03','Communication & Experience','Web・広告・PR・SNS・ECなど、ブランド接点と体験を設計'],
            ['04','Go-to-Market','販売チャネル・営業資料・展示会・ポップアップなど、市場投入を実行']
          ],
          note:'最新の4領域に沿って、戦略から市場投入までを一続きで理解できる流れにする。'
        },
        {
        ...
        {
          type:'capabilityCards', eyebrow:'WHY BLÜHEN', title:'Blühenが大切にしていること',
          cards:[
            ['価値を見つける','企業や商品の背景・文化まで理解し、そのものの中にある価値を捉える。'],
            ['言葉にする','価値をコンセプトと言葉へ整理し、コミュニケーションの軸をつくる。'],
            ['世界の文脈へ再設計する','単純な翻訳ではなく、市場・文化・読み手に合わせて表現を組み替える。'],
            ['チームを束ねて実装する','国内外のライター、デザイナー、クリエイター等を目的に応じて編成し、アウトプットまでディレクションする。']
          ],
